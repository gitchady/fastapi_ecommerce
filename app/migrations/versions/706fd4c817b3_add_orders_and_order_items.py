...
Revision ID: 706fd4c817b3
Revises: 006eebe47dcb
Create Date: 2026-02-22 23:21:26.749981
...
revision: str = '706fd4c817b3'
down_revision: Union[str, Sequence[str], None] = '006eebe47dcb'
...
def upgrade() -> None:
    ...
    sa.Column('comment_date', sa.TIMESTAMP(), server_default=sa.text('now()'), nullable=False),
    sa.Column('grade', sa.Integer(), nullable=False),
    sa.Column('is_active', sa.Boolean(), server_default='true', nullable=False),
    sa.CheckConstraint('grade BETWEEN 1 AND 5', name='grade_range_check'),
    sa.ForeignKeyConstraint(['product_id'], ['products.id'], ),
